...
import 'package:kanade_record_store/models/product_entry.dart';
...
class ProductPage extends StatefulWidget {
  ...
  @override
  State<ProductPage> createState() => _ProductEntryPageState();
}

class _ProductEntryPageState extends State<ProductPage> {
          ...
          if (snapshot.data == null) {
            ...
            if (!snapshot.hasData) {
              return const Column(
                children: [
                  Text(
                    'Belum ada data item pada kanade record store.',
