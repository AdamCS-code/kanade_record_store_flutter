...
import 'package:kanade_record_store/widgets/item_card.dart';

class MyHomePage extends StatelessWidget {
  final String npm = '2306227160'; // NPM
  final String name = 'Adam Caldipawell Sembiring'; // Nama
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Padding(
                    ...
                    child: Text(
                      'Welcome to Kanade Record Store',
                      style: TextStyle(
                        fontWeight: FontWeight.bold,
                        fontSize: 18.0,
                      ),
